...
\chapter*{Etape 1}
\addcontentsline{toc}{chapter}{Etape 1}
\section*{Diagramme détaillé du modèle (niveau Conception)}
\addcontentsline{toc}{section}{Diagramme détaillé du modèle (niveau Conception)}
...
\chapter*{Etape 2}
\addcontentsline{toc}{chapter}{Etape 2}

\section*{Consulter lecteur}
\addcontentsline{toc}{section}{Consulter lecteur}

Auteur : Arnaud MAILLET
Relecteur : Christophe VARGAS

\subsection*{DS Conception MVC}
\addcontentsline{toc}{subsection}{DS Conception MVC}
...
\addcontentsline{toc}{subsection}{DS Conception}
\bigskip
...
\addcontentsline{toc}{section}{Consulter ouvrage}
...
\addcontentsline{toc}{section}{Nouvel ouvrage}
...
\addcontentsline{toc}{section}{Nouvel exemplaire}
...
\addcontentsline{toc}{section}{Rendre exemplaire empruntable}
...
\addcontentsline{toc}{section}{Diagramme de classe}
...
\addcontentsline{toc}{section}{Diagramme d'états-transitions de la classe exemplaire}
