 ...
 * @author ksz
 */
public class CtrNouvAuteurOuvGUI extends javax.swing.JDialog {
    ...
    public CtrNouvAuteurOuvGUI(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        parent_frame = parent;
        initComponents();
    ...
    public void menuPrincipal(Bibliotheque bib, CtrNouvOuvrageGUI fenetre) {
        biblio = bib;
        fenetreOuv = fenetre;
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                CtrNouvAuteurOuvGUI dialog = new CtrNouvAuteurOuvGUI(new javax.swing.JFrame(), true);
